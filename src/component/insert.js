               ...
               <div className="card cardNew">
                <form onSubmit={this.onSubmit} id="myForm" >
                    <div className="form-group">
                        ...
                        <small id="NameHel  per" className="form-text" style={{color:'red'}}>{errors.name}</small>}
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input required={true}  type="text" className="form-control" value={this.state.number} onChange={this.onChangeNumber}  placeholder="Enter Mobile Number"/> 
                    ...
                    <div className="form-group">
                        <div className="custom-file">
                            <input required={true} type="file" accept="image/png, image/jpeg" className="custom-file-input" onChange={this.onChangeFile} id="customFile"/>
